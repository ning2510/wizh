...
func publishInfoHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(video.PublishInfoRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(video.VideoService).PublishInfo(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *PublishInfoArgs:
		success, err := handler.(video.VideoService).PublishInfo(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*PublishInfoResult)
		realResult.Success = success
	}
	return nil
}
func newPublishInfoArgs() interface{} {
	return &PublishInfoArgs{}
}

func newPublishInfoResult() interface{} {
	return &PublishInfoResult{}
}

type PublishInfoArgs struct {
	Req *video.PublishInfoRequest
}

func (p *PublishInfoArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(video.PublishInfoRequest)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *PublishInfoArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *PublishInfoArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *PublishInfoArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *PublishInfoArgs) Unmarshal(in []byte) error {
	msg := new(video.PublishInfoRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var PublishInfoArgs_Req_DEFAULT *video.PublishInfoRequest

func (p *PublishInfoArgs) GetReq() *video.PublishInfoRequest {
	if !p.IsSetReq() {
		return PublishInfoArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *PublishInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *PublishInfoArgs) GetFirstArgument() interface{} {
	return p.Req
}

type PublishInfoResult struct {
	Success *video.PublishInfoResponse
}

var PublishInfoResult_Success_DEFAULT *video.PublishInfoResponse

func (p *PublishInfoResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(video.PublishInfoResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *PublishInfoResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *PublishInfoResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *PublishInfoResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *PublishInfoResult) Unmarshal(in []byte) error {
	msg := new(video.PublishInfoResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *PublishInfoResult) GetSuccess() *video.PublishInfoResponse {
	if !p.IsSetSuccess() {
		return PublishInfoResult_Success_DEFAULT
	}
	return p.Success
}

func (p *PublishInfoResult) SetSuccess(x interface{}) {
	p.Success = x.(*video.PublishInfoResponse)
}

func (p *PublishInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *PublishInfoResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) PublishInfo(ctx context.Context, Req *video.PublishInfoRequest) (r *video.PublishInfoResponse, err error) {
	var _args PublishInfoArgs
	_args.Req = Req
